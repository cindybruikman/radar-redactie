...
import { supabase } from "@/lib/supabaseClient"; // zorg dat deze klopt
...
const mockSavedLeads: SavedLead[] = [
  {
    ...
    description:
      "Bewoners klagen over vroege werkzaamheden en trillingen door bouwproject",
    ...
    notes:
      "Contact opgenomen met omwonenden. Gemeente heeft nog niet gereageerd.",
  ...
  },
  {
    ...
    neighborhood: "West",
    notes:
      "Artikel gepubliceerd op 12 januari. Follow-up over gebruik na opening.",
  ...
  },
  {
    ...
    description:
      "Klachten over tekort aan parkeerplekken bij winkelcentrum Heuvel",
    savedBy: "Tom Bakker",
